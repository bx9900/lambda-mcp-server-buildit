...
import { z } from "zod";
import { LambdaClient, CreateFunctionCommand, UpdateFunctionConfigurationCommand, UpdateFunctionCodeCommand, DeleteFunctionCommand, GetFunctionConfigurationCommand, ListFunctionsCommand, InvokeCommand } from "@aws-sdk/client-lambda";
...
server.tool("listFunctions", {}, async () => {
    try {
